...
class acf_field_tripcraft_hotel_id extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Tripcraft Hotel ID', 'acf-tripcraft_hotel_id');
		...
		*  var message = acf._e('tripcraft_hotel_id', 'error');
		*/

		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-tripcraft_hotel_id'),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Font Size','acf-tripcraft_hotel_id'),
			'instructions'	=> __('Customise the input font size','acf-tripcraft_hotel_id'),
			'type'			=> 'number',
			'name'			=> 'font_size',
			'prepend'		=> 'px',
		));
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		// wp_register_script( 'acf-input-tripcraft_hotel_id', "{$url}assets/js/input.js", array('acf-input'), $version );
		...
		// wp_register_style( 'acf-input-tripcraft_hotel_id', "{$url}assets/css/input.css", array('acf-input'), $version );
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-tripcraft_hotel_id'),
		}
